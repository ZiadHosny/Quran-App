...
const generateList = ({ id, quranReciter, quranReciterEn, photo, website, quranReciterInWebsite, websiteUrl, }) => {
    ...
    for (let i = 1; i <= 114; i++) {
        ...
        list.push({
            ...
            ayahs: suwar_1.QURAN_SUWAR[i - 1].ayahs,
            type: suwar_1.QURAN_SUWAR[i - 1].type,
            quranReciter,
            quranReciterEn,
            photo,
            url,
...
const generateSingleReciter = ({ arrOfSuwar, reciter, url, }) => {
    ...
    arrOfSuwar.forEach((surahNumber) => {
        ...
        reciterSuwar.push({
            ...
            ayahs: suwar_1.QURAN_SUWAR[surahNumber - 1].ayahs,
            type: suwar_1.QURAN_SUWAR[surahNumber - 1].type,
            photo,
            quranReciter,
            quranReciterEn,
            surahNumber,
